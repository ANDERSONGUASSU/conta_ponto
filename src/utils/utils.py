...
def open_in_browser(chart_path, css_styles, title):
    ...
    modified_html_content = html_content.replace("</head>", f"{css_styles}</head>")
    modified_html_content = modified_html_content.replace("Awesome-pyecharts</title>", f"{title}</title>")
